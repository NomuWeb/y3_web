  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <AnimatedSection id="contact" className="py-20 bg-zinc-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-6 text-center hover:text-blue-400 transition-colors">Contact Us / お問い合わせ</h2>
          ...
          <div className="flex justify-center space-x-6 mt-8">
            <a
              href="#"
              className="w-12 h-12 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-blue-500/50 transform hover:scale-110 transition-all duration-300"
            ...
            <a
              href="#"
              className="w-12 h-12 bg-gradient-to-br from-sky-400 to-sky-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-sky-500/50 transform hover:scale-110 transition-all duration-300"
              aria-label="Twitter"
            >
              <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
